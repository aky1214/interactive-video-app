<template>
  <div class="col">
    <div class="card p-4">
      ...
      >
        <h4 class="card-title">Input-{{ formIndex + 1 }}</h4>
        <button @click="deleteInput(formIndex)" class="btn btn-outline-danger">
          Delete
        </button>
      </div>
      ...
      <div class="d-flex align-items-center justify-content-between p-0">
        <input
          ...
          type="text"
          id="btn_label"
          :placeholder="`Enter Input ${formIndex} label...`"
          v-model="inputName"
        />
        <input
          @keyup="emitData()"
          ...
          type="text"
          id="btn_url"
          :placeholder="`Enter input ${formIndex} placeholder...`"
          v-model="placeholder"
        />
